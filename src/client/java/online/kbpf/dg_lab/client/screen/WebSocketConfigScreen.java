...
public class WebSocketConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        host.setHint(Component.literal("this").withStyle(style -> style.withColor(0xffaaaaaa)));
        ...
        port.setHint(Component.literal("9999").withStyle(style -> style.withColor(0xffaaaaaa)));
        ...
        serverPort.setHint(Component.literal("9999").withStyle(style -> style.withColor(0xffaaaaaa)));
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(font, Component.literal("二维码连接的地址"), (int) (width * 0.1), 49, 0xffffffff);
        graphics.text(font, Component.literal(modConfig.getNetwork()), (int) (width * 0.1), 61, 0xffaaaaaa, false);
        graphics.text(font, Component.literal("二维码连接的端口"), (int) (width * 0.1), 74, 0xffffffff);
        graphics.text(font, Component.literal("服务器开放的端口"), (int) (width * 0.1), 99, 0xffffffff);
