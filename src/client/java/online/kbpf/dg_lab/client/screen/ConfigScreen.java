...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        secondPlayerName = new EditBox(client.font, (int) ((double) width / 2 + 6 + (int) (width * 0.2)), 140 - (2 * (ButtonDistance + ButtonHeight)), (int) (width * 0.2), ButtonHeight, Component.literal("输入玩家名字"));
